    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="custex.php">CUSTOMERS</a></li>
        ...
        <header class="masthead bg-primary text-white text-center">
            ...
            <div class="container body">
                <form action="transdet.php?name=<?php echo $_GET['name'];?>" method="post">
                
    <div class="row">
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card card-signin flex-row my-5">
          <div class="card-body">
            <h5 class="card-title text-center" style="color:black;">Transfer Portal</h5>
            <form class="form-signin">
              <div class="form-label-group">
                <input type="text" id="inputUserame" name="sendername" class="form-control"  required autofocus>
                <label for="sendername">Sender Name</label>
              </div>
              <?php
                $sendername=isset($_POST['sendername']) ? $_POST['sendername'] : '';
                $sql="SELECT curr_bal FROM customer WHERE cust_name='$sendername'";
                $bal=mysqli_query($link, $sql);
                ?>
              <div class="form-label-group">
                <p class="form-control"> Receiver Name: <?php echo $_GET['name'];?></p>
              </div>
              
              <hr>

              <div class="form-label-group">
                <input type="Number" id="inputPassword" name="amount" class="form-control" required>
                <label for="amount">Amount</label>
              </div>
              
              <div class="form-label-group">
                <input type="text" id="inputConfirmPassword" name="email" class="form-control" required>
                <label for="email">Email Address</label>
              </div>

              <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" value="Submit Data">Transfer</button>
            </form>
          </div>
        </div>
      </div>
