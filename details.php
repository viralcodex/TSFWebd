    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="custex.php">CUSTOMER</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="custdet.php">TRANSFER</a></li>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <h1 class="masthead-heading text-uppercase mb-0">Customer Details</h1>
                <p>
                ...
                <?php
                    ...
                    echo "Customer Name: ",$details[1], "<br>";
                    echo "Customer Email: ",$details[2], "<br>";
                    echo "Current Account Balance: Rs.",$details[3], "<br>";
                    echo "Account Opening Date: ",$details[4], "<br>";
                    mysqli_close($link);
                ?>
                </p>
            </div>
            <div class="text-center mt-4">
                 <?php
                     $url="trans2.php?name=".urlencode($details[1]);
                 ?>
